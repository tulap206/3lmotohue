...
def execute_mac_sync() -> tuple[bool, str, str]:
    """Kích hoạt mở Find My trên Mac và cào dữ liệu vị trí thật đẩy lên Cloud"""
    candidates = []

    # 1. Native binary đã biên dịch từ Swift (Truy xuất trực tiếp UI Find My chính xác 100%)
